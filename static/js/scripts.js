(function ($) {
  ...
  swiperslider.each(function () {  
			  ...
			  if( columns === 1 ){ 
                ...
                var responsive_items = [ /* 1199 : */ columns, /* 991 : */ '2.6', /* 767 : */ '2', /* 575 : */ '2', /* 0 : */ '1' ];
              } else if( columns === 3 ){ 
...
if( $('#pbmit-clock').length>0 ){
	$('#pbmit-clock').countdown('2024/10/10', function(event) {
		$(this).html(event.strftime(''
		+ '<div class="count-time"><span class="time_left">86</span><span class="time_description">Day%!d </span></div>'
		+ '<div class="count-time"><span class="time_left">05</span><span class="time_description"> Hours </span></div> '
		+ '<div class="count-time"><span class="time_left">33</span><span class="time_description"> Minutes </span></div>'
